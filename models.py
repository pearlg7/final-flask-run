...
class Run(db.Model):
    ...
    def __init__(self,date,distance,pace,heart_rate,user_token, id = ''):
        self.id = self.set_id()
        self.date = date
    ...
    def __repr__(self):
        return f'The following runner has been added to the app: {self.name}'
...
class RunSchema(ma.Schema):
    class Meta:
        fields = ['id', 'date','distance','pace', 'heart_rate']
